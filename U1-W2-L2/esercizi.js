...
let a = 2
let b = 5
if(a > b){console.log ("a è il numero più grande")}
else {console.log("b è il numero più grande")}
...
let e = 4
let f = 12
if (e,f === 8 || e + f === 8){console.log(true)} 
...
/*oppure delete me.skills.pop()*/
/*oppure delete me.sills[skills lenght-1]*/
